...
if(isset($_POST['submit'])){
	...
	if($result == 0){
		$_SESSION['loggedin'] = 1;
		header('Location: http://pmoalmeida.site50.net/menu.php');
	}
	else {
		echo '<center>Wrong <font color="red"><b>credentials!</b></font></center>';
	}
	}
?>
...
<head>
  ...
  <title>Login - Exciting Corner</title>
...
<body>
  <section class="container">
    <div class="login">
      <h1>Login to Exciting Corner</h1>
